        ...
        <form action="{{ route('sppk.hitung') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="kriteria-row" id="kriteria-row-1">
                    <div class="kriteria-group">
                        <div class="bobot-info">
                            ...
                            <input type="text" name="nama_kriteria[]" class="input-nama" placeholder="Nama Kriteria"
                                required>
                            <input type="number" step="0.01" name="bobot[]" class="input-bobot"
                                placeholder="Nilai Kriteria" required>
                        </div>
                        <div class="tipe-kriteria">
                            <input type="radio" id="benefit1" name="tipe_kriteria[0]" value="benefit" required>
                            <label for="benefit1">Benefit</label>
                            <input type="radio" id="cost1" name="tipe_kriteria[0]" value="cost">
            ...
            <div class="add-group-section">
                <div class="add-kriteria-note">
                    Tekan tombol (+) untuk<br>menambahkan kriteria baru.
                </div>
        ...
        const newRowHtml = `
                <div class="kriteria-row" id="kriteria-row-${kriteriaCount}">
                    <div class="kriteria-group">
                        ...
                        <div class="tipe-kriteria">
                            <input type="radio" id="benefit${kriteriaCount}" name="tipe_kriteria[${kriteriaCount - 1}]" value="benefit" required>
                            <label for="benefit${kriteriaCount}">Benefit</label>
                            <input type="radio" id="cost${kriteriaCount}" name="tipe_kriteria[${kriteriaCount - 1}]" value="cost">
